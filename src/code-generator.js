...
console.log(`Full URL: https://www.etsy.com/oauth/connect?response_type=code&redirect_uri=http://localhost:3003/oauth/redirect&scope=email_r&client_id=yczqz18re5c49000w2gfu078&state=${state}&code_challenge=${codeChallenge}&code_challenge_method=S256`)